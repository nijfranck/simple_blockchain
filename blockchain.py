...
class Blockchain(object):
    ...
    def new_transaction(self, sender, recipient, amount):
        ...
        # (the block with the transaction will be added to which is the block that the new transaction belongs to)
    ...
    def hash(block):
        ...
        # Dictionaries with different keys orders have different hashes
...
def mine():
    # This is where the magic happens. Three things happen:
...
def register_self():
    ...
    print(node)
    if node is None:
        return "Error: Could not retrieve address", 400
